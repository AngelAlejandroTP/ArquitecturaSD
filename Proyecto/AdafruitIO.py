...
# Wireless network
WIFI_SSID = "Redmi"
WIFI_PASS = "Trujeque1" # No this is not our regular password. :)

# Adafruit IO (AIO) configuration
AIO_SERVER = "io.adafruit.com"
AIO_PORT = 1883
AIO_USER = "MarioTrujeque"
AIO_KEY = "aio_kQhS42FRgJgDSzX4mfXqvkqkaYep"
AIO_CLIENT_ID = ubinascii.hexlify(machine.unique_id())  # Can be anything
AIO_CONTROL_FEED = "MarioTrujeque/feeds/luces"
AIO_RANDOMS_FEED = "MarioTrujeque/feeds/numeros"
